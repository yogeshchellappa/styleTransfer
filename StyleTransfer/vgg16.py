...
def check_if_vgg16_exists():
    ...
    file_path = os.path.join(data_dir, data_dir)
...
def maybe_download():
    """
    Download the VGG16 model if it does not already
    exist in the data_dir.
    """
    print("Downloading VGG16 Model ...")
    downloadVgg16.maybe_download_and_extract(url=data_url, download_dir=data_dir)
